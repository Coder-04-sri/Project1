  ...
  const [isOpen, setIsOpen] = useState(false);
    ...
    return (
      ...
      <section className="mt-10">
        <ul className="lg:flex ml-6 md:flex md:flex-wrap lg:flex-wrap justify-center lg:gap-12 md:gap-10 md:mr-5 lg:mr-0 lg:text-lg md:text-[40px] font-medium text-gray-600 cursor-pointer">
