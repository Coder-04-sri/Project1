...
import ClassicThinCutFries from '../frenchFries/ClassicThinCutFries.jpg';
import CrinkleCutFries from '../frenchFries/CrinkleCutFries.jpg';
import CurlyFries from '../frenchFries/CurlyFries.jpg';
import ThickCutSteakFries from '../frenchFries/ThickCutSteakFries.jpg';
import WaffleFries from '../frenchFries/WaffleFries.jpg';
import FrenchBistroFries from '../frenchFries/FrenchBistroFries.jpg';
import TatorTotFries from '../frenchFries/TatorTotFries.jpg';
import SweetPotatoFries from '../frenchFries/SweetPotatoFries.jpg';

 


const frenchItems = [
  { name: 'Classic Thin Cut', image: ClassicThinCutFries    ,price:"$25"  },
  { name: 'Thick Cut Steak Fries', image: ThickCutSteakFries  ,price:"$25"   },
  { name: 'Curly Fries', image: CurlyFries ,price:"$25"   },
  { name: 'waffle Fries', image: WaffleFries  ,price:"$25"    },
  { name: 'Sweet Potato Fries', image:  SweetPotatoFries   ,price:"$25"   },
  { name: 'French Bistro Fries ', image:FrenchBistroFries   ,price:"$25"  },
  { name: 'Crinkle Cut Fries', image: CrinkleCutFries  ,price:"$25" },
  { name: 'Tator Tot Fries', image: TatorTotFries   ,price:"$25" },
];
const FFries = () => {
